...
A database script(`database/ssgeek.sql`), an interface (`ForumDAO`), and a data access class (for you to implement) has been provided.
...
- The View Cart page should have a message telling them that a product was successfully added or changed in their cart using flash data
...
- Use the URL pattern `/shoppingCart/view`
